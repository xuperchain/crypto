...
// func TestSm2Asm(t *testing.T) {
// 	priv, err := GenerateKeyAsm() // 生成密钥对
// 	if err != nil {
// 		log.Fatal(err)
// 	}
// 	fmt.Printf("%v\n", priv.Curve.IsOnCurve(priv.X, priv.Y)) // 验证是否为sm2的曲线
...
// 	//}
// 	msg, _ = ioutil.ReadFile("ifile")                   // 从文件读取数据
// 	sign, err := privKey.SignAsm(rand.Reader, msg, nil) // 签名
// 	if err != nil {
// 		log.Fatal(err)
// 	}
// 	err = ioutil.WriteFile("ofile", sign, os.FileMode(0644))
...
// 	}
// 	signdata, _ := ioutil.ReadFile("ofile")
// 	ok = privKey.VerifyAsm(msg, signdata) // 密钥验证
// 	if ok != true {
// 		fmt.Printf("Verify error\n")
// 	} else {
// 		fmt.Printf("Verify ok\n")
// 	}
// 	ok = pubKey.VerifyAsm(msg, signdata) // 公钥验证
// 	if ok != true {
// 		fmt.Printf("Verify error\n")
// 	} else {
// 		fmt.Printf("Verify ok\n")
